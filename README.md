...
网页端还提供独立联动开关：暗环境自动开灯、暗环境人体经过亮灯、起夜记录统计、起夜联动开灯、告警强制开灯、气体异常通风、蜂鸣器告警、SOS 舵机动作、无人活动提醒。直接双击打开 `web/public/index.html` 时会进入本地演示模式；真实实时数据建议使用 `http://localhost:3000`。
